...
save_button = ctk.CTkButton(main_container, text="Save as PNG", width=250, height=50, font=ctk.CTkFont(size=16), state="disabled", fg_color="gray", command=save_barcode)
